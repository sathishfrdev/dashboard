export const born = [
  ...
  export const sales = {
    2017: [
      { month: 'Jan', sale: 50, total: 100 },
      { month: 'Feb', sale: 10, total: 80 },
      { month: 'Mar', sale: 30, total: 10 },
      { month: 'Apr', sale: 10, total: 70 },
      { month: 'May', sale: 20, total: 30 },
      { month: 'Jun', sale: 50, total: 70 },
      { month: 'Jul', sale: 20, total: 50 },
      { month: 'Aug', sale: 10, total: 50 },
      { month: 'Sep', sale: 40, total: 30 },
      { month: 'Oct', sale: 30, total: 60 },
      { month: 'Nov', sale: 16, total: 40 },
      { month: 'Dec', sale: 13, total: 20 },
    ],
    2018: [
      { month: 'Jan', sale: 10, total: 100 },
      { month: 'Feb', sale: 20, total: 30 },
      { month: 'Mar', sale: 50, total: 20 },
      { month: 'Apr', sale: 27, total: 15 },
      { month: 'May', sale: 10, total: 30 },
      { month: 'Jun', sale: 10, total: 20 },
      { month: 'Jul', sale: 50, total: 80 },
      { month: 'Aug', sale: 20, total: 50 },
      { month: 'Sep', sale: 20, total: 20 },
      { month: 'Oct', sale: 13, total: 10 },
      { month: 'Nov', sale: 16, total: 50 },
      { month: 'Dec', sale: 15, total: 60 },
    ],
    2019: [
      { month: 'Jan', sale: 17, total: 56 },
      { month: 'Feb', sale: 15, total: 74 },
      { month: 'Mar', sale: 10, total: 98 },
      { month: 'Apr', sale: 33, total: 50 },
      { month: 'May', sale: 18, total: 40 },
      { month: 'Jun', sale: 20, total: 20 },
      { month: 'Jul', sale: 10, total: 30 },
      { month: 'Aug', sale: 10, total: 80 },
      { month: 'Sep', sale: 29, total: 100 },
      { month: 'Oct', sale: 18, total: 20 },
      { month: 'Nov', sale: 18, total: 19 },
      { month: 'Dec', sale: 12, total: 40 },
    ],
  };
